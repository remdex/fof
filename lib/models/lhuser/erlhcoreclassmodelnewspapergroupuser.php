...
class erLhcoreClassModelNewspaperGroupUser {
   ...
   {
   	 $group_user = erLhcoreClassUser::getSession('slave')->load( 'erLhcoreClassModelNewspaperGroupUser', (int)$assignee_id );
   	 return $group_user;
   }
   ...
   public static function removeUserFromGroups ( $user_id ) {
   		...
   		$q->deleteFrom( 'lh_newspaper_group_user' )
   ...
   {             
       ...
       $q = $session->createFindQuery( 'erLhcoreClassModelNewspaperGroupUser' );  
   ...
   public static function getCount($params = array())
   {
       ...
       $q->select( "COUNT(id)" )->from( "lh_newspaper_group_user" );   
   ...
   public $newspaper_group_id = NULL;
