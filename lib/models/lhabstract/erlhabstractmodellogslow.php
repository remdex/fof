...
class erLhAbstractModelLogSlow {
   ...
   public static function addLogMessage($message, $time) {
       $log = new erLhAbstractModelLogSlow();
       $log->atime = time();
       $log->message = $message;
       $log->ttime = $time;
       $log->saveThis();
   ...
   public static function getCount($params = array())
   {
       ...
       $q->select( "COUNT(id)" )->from( "lh_abstract_log_slow" );   
   ...
   {   
       if (isset($GLOBALS['CacheGlobalModelLogSlow_'.$id])) return $GLOBALS['CacheGlobalModelLogSlow_'.$id];         
       $GLOBALS['CacheGlobalModelLogSlow_'.$id] = erLhcoreClassAbstract::getSession()->load( 'erLhAbstractModelLogSlow', (int)$id );
       
       return $GLOBALS['CacheGlobalModelLogSlow_'.$id];
   }
   ...
   {             
       ...
       $session = erLhcoreClassAbstract::getSession();
       $q = $session->createFindQuery( 'erLhAbstractModelLogSlow' );  
      ...
      $q->orderBy('id DESC');
       ...
       $objects = $session->find( $q, 'erLhAbstractModelLogSlow' );
