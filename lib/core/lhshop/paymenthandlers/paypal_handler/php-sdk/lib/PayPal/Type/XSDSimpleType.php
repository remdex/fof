 ...
 */
require_once 'lib/core/lhshop/paymenthandlers/paypal_handler/php-sdk/lib/PayPal/Type/XSDType.php';
...
class XSDSimpleType extends XSDType
{
    ...
    function &getSoapValue($name, $ns = null)
	    {
	        include_once 'lib/core/lhshop/paymenthandlers/paypal_handler/php-sdk/lib/PayPal/SOAP/Value.php';
