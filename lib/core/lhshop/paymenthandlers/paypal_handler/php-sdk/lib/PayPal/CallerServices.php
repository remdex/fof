...
class CallerServices extends SOAP_Client
{
    ...
    function CallerServices($profile)
    {
        ...
        include 'lib/core/lhshop/paymenthandlers/paypal_handler/php-sdk/lib/PayPal/wsdl/paypal-endpoints.php';
        $this->_endpointMap = $PayPalEndpoints;

        // Load SDK settings.
        if (@include 'lib/core/lhshop/paymenthandlers/paypal_handler/php-sdk/lib/PayPal/conf/paypal-sdk.php') {
