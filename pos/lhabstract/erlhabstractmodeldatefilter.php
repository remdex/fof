...
$def->table = "lh_abstract_date_filter";
$def->class = "erLhAbstractModelDateFilter";
...
$def->properties['position']->propertyType = ezcPersistentObjectProperty::PHP_TYPE_STRING; 
