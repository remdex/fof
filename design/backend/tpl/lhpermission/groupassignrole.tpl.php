...
<br />
<div>
<input type="submit" class="small button" name="AssignRoles" value="<?=erTranslationClassLhTranslation::getInstance()->getTranslation('permission/groupassignrole','Assign');?>" />
</div>
</form>