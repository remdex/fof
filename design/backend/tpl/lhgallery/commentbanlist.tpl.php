<div class="header-list"><h1><?=erTranslationClassLhTranslation::getInstance()->getTranslation('gallery/ratebanlist','Baned IP for commenting');?></h1></div>
...
<? foreach ($items as $user) : ?>
    <tr>
        ...
        <td><a onclick="return confirm('<?=erTranslationClassLhTranslation::getInstance()->getTranslation('gallery/ratebanlist','Are you sure?');?>')" href="<?=erLhcoreClassDesign::baseurl('pnadmin/commentbanlist')?>/(delete)/<?=$user->id?>"><img src="<?=erLhcoreClassDesign::design('images/icons/delete.png');?>" alt="<?=erTranslationClassLhTranslation::getInstance()->getTranslation('gallery/ratebanlist','Delete ip');?>" title="<?=erTranslationClassLhTranslation::getInstance()->getTranslation('gallery/ratebanlist','Delete ip');?>" /></a></td>
    </tr>
<? endforeach; ?>
</table>
<br />
