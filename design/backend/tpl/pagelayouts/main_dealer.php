    ...
    <div id="main-header-bg">
        ...
        <div class="top-menu float-break">
        	<ul>
        	    ...
        	    <li><a href="<?=erLhcoreClassDesign::baseurl('pnadmin/lastpdf')?>"><?=erTranslationClassLhTranslation::getInstance()->getTranslation('pagelayout/pagelayout','Latest PDF');?></a></li>    	   
        	    <li><a href="<?=erLhcoreClassDesign::baseurl('pnadmin/lastnotices')?>"><?=erTranslationClassLhTranslation::getInstance()->getTranslation('pagelayout/pagelayout','Latest notices');?></a></li>    	   
        	    <li><a href="<?=erLhcoreClassDesign::baseurl('pnadmin/lastcomments')?>"><?=erTranslationClassLhTranslation::getInstance()->getTranslation('pagelayout/pagelayout','Latest comments');?></a></li>    	   
        	    ...
        	    <?php if ( erLhcoreClassUser::instance()->hasAccessTo('lhabstract','use') ) : ?>
        	    ...
        	    <?php else : ?>
        	    <li><a href="<?=erLhcoreClassDesign::baseurl('abstract/listnewspaper')?>/NewspaperGroup"><?=erTranslationClassLhTranslation::getInstance()->getTranslation('pagelayout/pagelayout','Newspaper configuration');?></a></li>
        	    <?php endif;?>
        	    ...
        	    <li><a href="<?=erLhcoreClassDesign::baseurl('pnadmin/reportmanagement')?>"><?=erTranslationClassLhTranslation::getInstance()->getTranslation('pagelayout/pagelayout','Report management');?></a></li>
        	    <li><a href="<?=erLhcoreClassDesign::baseurl('pnadmin/activity')?>"><?=erTranslationClassLhTranslation::getInstance()->getTranslation('pagelayout/pagelayout','Activity');?></a></li>
		...
		<div id="leftmenucont">
		       <?php if (isset($Result['left_menu'])) : ?>
		          <?php switch ($Result['left_menu']) {
		          	...
		          	<?php case 'abstract_newspaper': ?>
		          		 <?php include_once(erLhcoreClassDesign::designtpl('pagelayouts/parts/sidemenu/abstract_newspaper.tpl.php')); ?>
		          	<?php break; ?>
		          		
		          	<?php case 'comments': ?>
		          		 <?php include_once(erLhcoreClassDesign::designtpl('pagelayouts/parts/sidemenu/comments.tpl.php')); ?>
		          	<?php break; ?>
