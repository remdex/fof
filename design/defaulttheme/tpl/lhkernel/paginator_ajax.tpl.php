...
<div class="nav-container">
    ...
    <?php if ($pages->current_page != 1) : ?>    
        <a class="previous" onclick="hw.goToPage('<?php echo $pages->serverURL,$pages->prev_page,$pages->querystring?>')"></a>    
    <?php endif;?>
   ...
   $pageURL = $i > 1 ? '/(page)/'.$i : '';
    ...
    <a class="next" onclick="hw.goToPage('<?php echo $pages->serverURL,'/(page)/',$pages->next_page,$pages->querystring?>')"></a>
