 ...
 * @version 1.4.7
 */
abstract class ezcQueryMongoDb
{
    /**
    ...
    public function bindValue($parameter,$value = null, $data_type = 0){
        return $parameter;
    }
    ...
    static public function arrayFlattenRecursiv( array $array )
    {
        $flat = array();
        foreach ( $array as $arg )
        {
            ...
            {
                case 'array':
                    $flat = array_merge_recursive( $flat, $arg );
                    break;
