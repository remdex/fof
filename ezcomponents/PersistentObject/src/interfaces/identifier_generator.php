...
abstract class ezcPersistentIdentifierGenerator
{
     ...
     */
    public function checkPersistence( ezcPersistentObjectDefinition $def, $db, array $state )
    {
     ...
     * @return void
     */
    abstract public function preSave( ezcPersistentObjectDefinition $def, $db, $q );
     ...
     * @return int
     */
    abstract public function postSave( ezcPersistentObjectDefinition $def, $db );
}
